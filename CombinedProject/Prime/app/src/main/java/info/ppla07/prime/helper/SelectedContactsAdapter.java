...
public class SelectedContactsAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String[] text = list.get(position).split("\\|");

        //Handle TextView and display string from your list
        TextView listNameText = (TextView)view.findViewById(R.id.list_item_string);
        listNameText.setText(text[0]);
        TextView listNumberText = (TextView)view.findViewById(R.id.list_item_string_numb);
        listNumberText.setText("\n"+text[1]);
